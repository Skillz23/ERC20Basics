// ================================================
// Scroll DeFi 0x Integration for Token Swapping
// ================================================
// This script integrates with the Scroll blockchain and 0x API to perform
// token swaps, display liquidity sources, token taxes, and enable affiliate
// fee monetization. The code also handles Permit2 approval for token spending
// and submits transactions on-chain.
// ================================================
